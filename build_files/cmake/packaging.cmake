...
if(WIN32)
  ...
  set(CPACK_NSIS_MUI_ICON ${CMAKE_SOURCE_DIR}/release/windows/icons/winblended.ico)
  ...
  set(CPACK_WIX_PRODUCT_ICON ${CMAKE_SOURCE_DIR}/release/windows/icons/winblended.ico)
...
set(CPACK_PACKAGE_EXECUTABLES "blended-launcher" "Blended ${MAJOR_VERSION}.${MINOR_VERSION}")
set(CPACK_CREATE_DESKTOP_LINKS "blended-launcher" "Blended ${MAJOR_VERSION}.${MINOR_VERSION}")

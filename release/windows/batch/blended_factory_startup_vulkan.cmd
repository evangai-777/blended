@echo off
echo Starting Blended with factory settings, log files will be created
...
"%~dp0\Blended" --factory-startup --gpu-backend vulkan --python-expr "import bpy; bpy.context.preferences.filepaths.temporary_directory=r'%DEBUGLOGS%'; bpy.ops.wm.sysinfo(filepath=r'%DEBUGLOGS%\blended_system_info.txt')" > "%DEBUGLOGS%\blended_debug_output.txt" 2>&1 < %0
explorer "%DEBUGLOGS%"

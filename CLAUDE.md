...
| 0.7.x | App lenses — launcher (§11), all 28 mode lenses (§12), full product identity (§16), `.blended` format design. Two phases: skeleton first, aesthetic second. | Phase 1 + Phase 2 partial ✓ CI-complete (build 97, commit `aa6ec698`). Logo ✓ + accent ✓ (`#ff7f00`). Pending: app icon, splash visual |
